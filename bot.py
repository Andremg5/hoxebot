...
# TOKEN = '6742879145:AAGPgbyFxuxDnPXlVROu4_pVMl5MYGu7Lpc'

if TOKEN==None:
    print("Lemabra indicar a variable TOKEN")
    print("p.ex:docker run --rm -e TOKEN=o_teu_token nomebot")
    exit()

# Show logs in terminal (funcionaría sin esto)
logging.basicConfig(
...
if __name__ == '__main__':
    ...
    # Handler to manage the start command (manejadores de eventos)
